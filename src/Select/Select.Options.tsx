...
export function SelectOptions({
  ...
  return (
    <Transition as={Fragment} leave='transition ease-in duration-150' leaveFrom='opacity-100' leaveTo='opacity-0' afterLeave={() => onClose && onClose()}>
      <Listbox.Options className='absolute mt-2 max-h-60 w-full overflow-auto rounded border border-neutral-detail-paler bg-neutral-layer-2 paragraph-sm-lighter focus:outline-none' {...props} />
    </Transition>
  );
}
